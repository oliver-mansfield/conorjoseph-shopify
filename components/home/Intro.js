...
const Intro = () => {
	...
	return (
		<div className="p-6 md:p-10 lg:my-40" ref={introRef}>
			<div className="max-w-2xl grid grid-cols sm:grid-cols-2 gap-5 mx-auto">
				<p className="leading-8 text-base md:text-xl first-letter:text-7xl md:leading-8">
				...
				<p className="leading-8 mt-2 text-base md:text-xl md:leading-8 md:mt-[38px]">
